...
class ExploreScreen extends StatelessWidget {
  ...
  Widget showTitleBanner(int index) {
    return Text(
      titles[index],
      style: TextStyle(
          fontFamily: 'OpenSansRegular',
  ...
  Widget showImageBanner(int imgIndex) {
    return Container(
  ...
  Widget mySizeBox(double myDouble) {
    return SizedBox(
      height: myDouble,
    );
  }
        ...
        child: new Row(
          children: [
            new Row(children: [
              Column(
                children: <Widget>[
                  showImageBanner(imgIndex),
                  mySizeBox(6.0),
                  showTitleBanner(index),
                ],
              ),
            ])
          ],
